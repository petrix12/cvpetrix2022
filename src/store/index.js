...
export default createStore({
	state: {
		...
		cursos: [
			...
			{ id: 261, name: 'Curso de Postman', category: 'Herramientas', technology: 'Postman', url: 'https://campus-ademass.com/curso/113', platform: 'Ademass', costo: 0, money: 'USD', comprado: true, priority: 0, minutos: 201, culminado: '2024-10-12', certificado: 'https://campus-ademass.com/aut/14342', url_certificado: '', instructor: 'Diego Bastidas', description: 'Aprende a realizar peticiones a APIs a través del programa más popular entre desarrolladores.', url_aux: '', calificacion: 'Bueno', actualizado: true, en_ruta: false, logo_platform: 'ademass', logo_technologies: [ 'postman' ], mostrar: false, repositorio: '', nota: '' },
