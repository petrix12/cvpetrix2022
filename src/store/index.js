...
export default createStore({
	state: {
		...
		cursos: [
			...
			{ id: 174, name: 'MEAN Stack: Master nodejs y angular', category: 'Stack', technology: 'MEAN', url: 'https://www.udemy.com/course/master-deno-angular', platform: 'Udemy', costo: 12.99, money: 'EUR', comprado: true, priority: 0, minutos: 990, culminado: '2022-03-29', certificado: 'UC-709c1aec-acf3-4e8f-be19-a38c4bb570d6', url_certificado: 'https://udemy-certificate.s3.amazonaws.com/pdf/UC-709c1aec-acf3-4e8f-be19-a38c4bb570d6.pdf', instructor: 'Vaxi Drez Arcila', description: 'Crea Aplicaciones con angular nodejs express desde cero a nivel experto MEAN Stack', url_aux: '', calificacion: 'Bueno', actualizado: true, en_ruta: true, logo_platform: 'udemy', logo_technologies: [ 'mongo','express','angular','nodejs' ], mostrar: true, repositorio: 'https://github.com/petrix12/mean2022', nota: '' },
			...
			{ id: 212, name: 'Node: De cero a experto', category: 'Back-end', technology: 'Node.js', url: 'https://www.udemy.com/course/node-de-cero-a-experto', platform: 'Udemy', costo: 9.99, money: 'EUR', comprado: true, priority: 1, minutos: 1715, culminado: null, certificado: '', url_certificado: '', instructor: 'Fernando Herrera', description: 'Rest, despliegues, Heroku, Mongo, Git, GitHub, Sockets, archivos, JWT y mucho más para ser un experto en Node.', url_aux: '', calificacion: '*En evaluación*', actualizado: true, en_ruta: true, logo_platform: 'udemy', logo_technologies: [ 'nodejs','mongodb','javascript','git','github','heroku' ], mostrar: true, repositorio: '', nota: '' },
			{ id: 213, name: 'Curso práctico de Docker y Microservicios (apto para todos)', category: 'Herramientas', technology: 'Docker', url: 'https://www.udemy.com/course/curso-practico-de-docker-y-microservicios-desde-cero', platform: 'Udemy', costo: 9.99, money: 'EUR', comprado: true, priority: 1, minutos: 535, culminado: null, certificado: '', url_certificado: '', instructor: 'Juan Ramos', description: 'Aprende por qué es importante, cómo funciona, y cómo empezar usar Docker en tus proyectos!', url_aux: '', calificacion: '*En evaluación*', actualizado: true, en_ruta: true, logo_platform: 'udemy', logo_technologies: [ 'docker','laravel','mongodb','phyton','mysql' ], mostrar: true, repositorio: '', nota: '' },
