...
## Diseño del componente para administrar cursos
1. Crear componente **src\components\Admin\Cursos.vue**:
    ```vue
    ```
2. Crear componente **src\components\Admin\CursosEdit.vue**:
    ```vue
    ```
3. Modificar vista **src\views\Admin.vue**:
    ```vue
    ```
4. mmmm
